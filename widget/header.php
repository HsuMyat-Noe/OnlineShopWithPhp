...
<body>
    ...
    <div class="container-fluid product-search d-md-none d-sm-block">
        <form class="d-flex w-60 p-3 mx-auto" role="search" method="GET" action="search-product.php">
            <input class="form-control me-2 text-muted search" type="search" name="query" placeholder="Search Something ..."
                aria-label="Search">
